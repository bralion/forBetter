...
const themes = [
    {
        ...
        name: "默认",
        selected: true,
        img: require("dashboard_2_7/dashboard/resource/images/theme1.jpg"),
        property: {
            body: {
    ...
    },
    {
        ...
        name: "清爽",
        selected: false,
        img: require("dashboard_2_7/dashboard/resource/images/theme2.jpg"),
        property: {
            body: {
    ...
    },
    {
        ...
        name: "动感",
        selected: false,
        img: require("dashboard_2_7/dashboard/resource/images/theme3.jpg"),
        property: {
            body: {
                backgroundColor: "#eee",
                backgroundImage: ""
    ...
    },
    {
        ...
        name: "雅致",
        selected: false,
        img: require("dashboard_2_7/dashboard/resource/images/theme4.jpg"),
        property: {
            body: {
                backgroundColor:
    ...
    },
    {
        ...
        name: "商务",
        selected: false,
        img: require("dashboard_2_7/dashboard/resource/images/theme5.jpg"),
        property: {
            body: {
                backgroundColor:
                    "linear-gradient(to bottom right, #2b375e , #345676)",
    ...
    },
    {
        ...
        name: "安稳",
        selected: false,
        img: require("dashboard_2_7/dashboard/resource/images/theme6.jpg"),
        property: {
            body: {
    ...
    },
    {
        ...
        name: "酷黑",
        selected: false,
        img: require("dashboard_2_7/dashboard/resource/images/theme7.jpg"),
        property: {
            body: {
    ...
    },
    {
        ...
        name: "自定义",
        selected: false,
        img: require("dashboard_2_7/dashboard/resource/images/theme8.jpg")
    }
];
...
const backgroundImage = [
    ...
    },
    {
        ...
        selected: false,
        img: "",
        backgroundImage: require("dashboard_2_7/dashboard/resource/images/theme/paper.jpg")
    },
    {
        type: "bluesky",
        name: "天空",
        selected: false,
        img: "",
        backgroundImage: require("dashboard_2_7/dashboard/resource/images/theme/bluesky.jpg")
    },
    {
        type: "sunlight",
        name: "光晕",
        selected: false,
        img: "",
        backgroundImage: require("dashboard_2_7/dashboard/resource/images/theme/sunlight.jpg")
    },
    {
        type: "sea",
        name: "海水",
        selected: false,
        img: "",
        backgroundImage: require("dashboard_2_7/dashboard/resource/images/theme/sea.jpg")
    },
    {
        type: "sunset",
        name: "日落",
        selected: false,
        img: "",
        backgroundImage: require("dashboard_2_7/dashboard/resource/images/theme/sunset.jpg")
    },
    {
        type: "galexy",
        name: "银河",
        selected: false,
        img: "",
        backgroundImage: require("dashboard_2_7/dashboard/resource/images/theme/galexy.jpg")
    },
    {
        type: "buzi",
        name: "商务",
        selected: false,
        img: "",
        backgroundImage: require("dashboard_2_7/dashboard/resource/images/theme/buzi.jpg")
    }
];
class PanelTheme extends Component {
    ...
    setTheme(newTheme) {
        //同步主题数据到全局
        let _theme = window.Dashboard.util.deepAssign(
