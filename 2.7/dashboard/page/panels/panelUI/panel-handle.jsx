...
class drillHandle extends Component {
    ...
    styleDispatcher(router) {
        ...
        return (
            {
                table: <PanelDrill {...router} noDrill={true}/>,
                ...
                regionMap: <PanelDrill {...router} />,
                heatVectorMap: <PanelDrill {...router} />,
                migrateVectorMap: <PanelDrill {...router}  noDrill={true} />,
                routeVectorMap: <PanelDrill {...router} noDrill={true}/>,
                migrateMap: null,
                routeMap: null,
                markerMap: null,
                heatMap: null,
