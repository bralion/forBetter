    ...
    update(isFirst) {
        ...
        function updataCom(){
            ...
            if (isCellReady || isQuery) {
                ...
                // if(ins.cfg.chartDefinition.query.isNoQuery){
        ...
        function listenHandle(insten){
            ins = insten;
            updataCom();
            window.Dashboard.event.unsubscribe('databind_component_id_rendered',listenHandle);
        }
        if (ins) {
            //更新状态中component
            updataCom();
        }/* else{
            window.Dashboard.event.subscribe('databind_component_id_rendered', listenHandle);
