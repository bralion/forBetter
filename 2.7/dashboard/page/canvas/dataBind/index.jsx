...
import "dashboard_2_7/dashboard/util/jquery-ui/jquery-ui.min";
import "dashboard_2_7/dashboard/util/jquery-ui/jquery-ui.structure.min.css";
import "dashboard_2_7/dashboard/util/jquery-ui/jquery-ui.theme.min.css";
import $ from "jquery";
                ...
                <div className="databind-pop-top">
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            if (ins) {
                                isQueryed =
                                    ins.cfg.chartDefinition.query.isQueryed; //是否是查询完成
                            }
